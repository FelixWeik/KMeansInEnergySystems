...
The methodology contains more steps than the methodologies of the papers above.
% Data collection
...
For each value $x$ in the dataset, \begin{equation}\label{eq:minmaxscaler} 
      x_{transformed} = \frac{x - x_{min}}{x_{max} - x_{min}}
\end{equation} \cite{JOJ-ENP} is applied.

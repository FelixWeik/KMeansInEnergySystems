...
\textit{Identification of Natural Disaster Impacted Electricity Load Profiles with k-means Clustering Algorithm} \cite{JES-IND} investigating load profile characteristics and identifying natural disaster impacted load profiles based on k-means clustering for Lombok, Indonesia.
